...
<body>
	...
	<div align="center">
		<form:form id="usrenrollment" name="usrenrollment" method="post"
			modelAttribute="user" action="/updateUser">
			...
			<spring:bind path="user.password">
				<input type="text" name="${status.expression}"
					value="${status.value}" placeholder="Pass" readonly="readonly" style="display: none;">
				<br />
			</spring:bind>
			...
			<spring:bind path="user.gender">
				<input type="text" name="${status.expression}" placeholder="gender"
					value="${status.value}">
				<br />
			</spring:bind>
			...
			<spring:bind path="user.salary">
				<input type="text" name="${status.expression}" placeholder="salary"
					value="${status.value}">
				<br />
			</spring:bind>
			...
			<spring:bind path="user.gotra">
				<input type="text" name="${status.expression}" placeholder="gotra"
					value="${status.value}">
				<br />
			</spring:bind>
			...
			<spring:bind path="user.smoker">
				<input type="text" name="${status.expression}" placeholder="Smoker"
					value="${status.value}">
				<br />
			</spring:bind>

			<spring:bind path="user.drinker">
				<input type="text" name="${status.expression}" placeholder="drinker"
					value="${status.value}">
				<br />
			</spring:bind>
			...
			<spring:bind path="user.state">
				<input type="text" name="${status.expression}" placeholder="State"
					value="${status.value}">
				<br />
			</spring:bind>
